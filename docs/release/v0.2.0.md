# cli-core v0.2.0 — Output Tower

**The load-bearing release.** v0.2.0 builds the output layer that every other
piece of cli-core — and every sibling crate in the cli collection — depends on:
...
allocation-free by test rather than by claim. Zero breaking changes against the
0.1.0 scaffold's frozen interface.
...
**None.** The 0.1.0 release froze the public interface in `docs/API.md`; v0.2.0
fills in the output portion of that contract without changing a signature.
...
- [README](https://github.com/jamesgober/cli-core/blob/main/README.md)
- [API Reference](https://github.com/jamesgober/cli-core/blob/main/docs/API.md)
- [Roadmap](https://github.com/jamesgober/cli-core/blob/main/dev/ROADMAP.md)
- [CHANGELOG](https://github.com/jamesgober/cli-core/blob/main/CHANGELOG.md)

---

**Full diff:** [`v0.1.0...v0.2.0`](https://github.com/jamesgober/cli-core/compare/v0.1.0...v0.2.0).
**Changelog:** [`CHANGELOG.md`](https://github.com/jamesgober/cli-core/blob/main/CHANGELOG.md#020---2026-06-30).
